...
CREATE TABLE media_readings (
    ...
    consumption_difference NUMERIC(12, 6) GENERATED ALWAYS AS (final_reading - initial_reading),
    unit_price NUMERIC(12, 2) NOT NULL,
    calculated_cost NUMERIC(12, 2) GENERATED ALWAYS AS ((final_reading - initial_reading) * unit_price),
