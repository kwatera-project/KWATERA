...
public class ReservationStatusValidator {
  public void validateTransition(ReservationStatus currentStatus, ReservationStatus newStatus) {
    ...
    if (currentStatus == newStatus)
      throw new IllegalArgumentException("Reservation already has the status: " + newStatus);

    boolean isValid =
        switch (currentStatus) {
          case PENDING ->
              newStatus == ReservationStatus.CONFIRMED || newStatus == ReservationStatus.CANCELLED;
          case CONFIRMED ->
