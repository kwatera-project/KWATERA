                    ...
                    {isLoggedIn ? (
                        <div className="relative" ref={profileDropdownRef}>
                            ...
                            >
                                ...
                                <span className={`font-semibold text-xs tracking-wider uppercase hidden md:block max-w-[100px] truncate transition-all duration-300 ${isScrolledActive ? '' : 'text-white'}`}>{displayName}</span>
                            </button>
