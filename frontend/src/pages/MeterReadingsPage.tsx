        ...
        <div className="max-w-3xl mx-auto p-8 min-h-screen text-[#1A1A1A] space-y-6 flex flex-col">
            ...
            <div className="border-b border-[#DACDCA] pb-4">
                ...
                <p className="text-sm text-[#7A7A7A] mt-1">
                    Upload water meter photos for check-in and check-out tracking.
                </p>
            </div>
            ...
            {waterReading?.initialReadingStatus === "REQUEST_MANUAL_REVIEW" && (
                <div className="flex items-center gap-3 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-r-xl text-blue-700 animate-fade-in shadow-sm">
                    ...
                    <span className="text-xs font-semibold leading-relaxed">Check-in reading was sent for manual review by the owner.</span>
                </div>
            )}
            ...
            {waterReading?.finalReadingStatus === "REQUEST_MANUAL_REVIEW" && (
                <div className="flex items-center gap-3 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-r-xl text-blue-700 animate-fade-in shadow-sm">
                    ...
                    <span className="text-xs font-semibold leading-relaxed">Check-out reading was sent for manual review by the owner.</span>
                </div>
            )}
        </div>
    );
