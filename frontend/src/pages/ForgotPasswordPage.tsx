                    ...
                    <div className="w-full max-w-md bg-white border border-gray-100 rounded-2xl shadow-xl p-8 sm:p-10 space-y-6">
                        ...
                        {submitted ? (
                            <div className="space-y-6">
                                <div className="p-6 rounded-xl bg-[#42211D]/5 border border-[#DACDCA] flex flex-col items-center gap-3 text-center">
                                    <div className="w-12 h-12 rounded-full bg-[#42211D]/10 flex items-center justify-center">
                                        <svg className="w-6 h-6 text-[#42211D]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
